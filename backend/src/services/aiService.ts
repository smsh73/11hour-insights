...
{
  "title": "주요 기사 제목 또는 페이지 제목 (여러 기사가 있으면 가장 중요한 기사 제목)",
  "content": "전체 페이지의 모든 기사 내용을 순서대로 정리한 텍스트",
  "summary": "페이지 전체 내용의 요약 (행사, 간증, 선교, 말씀, 컬럼, 샘물, 절기, 수련회, 양육프로그램, 성찬식, 세례식, 장례식, 찬양, 교회학교, 청년부, 부흥회, 특별새벽기도회, 큐티 등 중 분류)",
  "articleType": "기사 유형 (행사, 간증, 선교, 말씀, 컬럼, 샘물, 절기, 수련회, 양육프로그램, 성찬식, 세례식, 장례식, 찬양, 교회학교, 청년부, 부흥회, 특별새벽기도회, 큐티 등)",
  "author": "글쓴이 또는 기자 이름 (여러 명이면 모두 포함)",
  "images": [
    {
      "url": "이미지 URL (있는 경우)",
      "description": "이미지 설명"
  ...
  "events": [
    {
      "type": "이벤트 유형 (예: 예배, 모임, 행사, 세례식, 성찬식, 수련회, 부흥회, 특별새벽기도회 등)",
      "date": "YYYY-MM-DD 형식의 날짜 (있는 경우, 텍스트에서 추출)",
      "title": "이벤트 제목",
      "description": "이벤트 상세 설명 (장소, 시간, 참석자, 내용 등)",
      "location": "장소 (있는 경우)",
      "participants": ["참석자 또는 관련 인물들"]
    }
  ]
}

중요 지침:
1. 텍스트에서 날짜, 시간, 장소, 인물 이름을 정확히 추출하세요
2. 여러 기사가 있으면 모두 포함하되, 가장 중요한 기사를 title로 설정하세요
3. 이벤트가 있으면 반드시 events 배열에 포함하세요
4. 기사 유형을 정확히 분류하세요
5. 한글 인코딩을 올바르게 처리하세요
